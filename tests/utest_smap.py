...
class SMap3x3UTestCase(unittest.TestCase):
    ...
    def test_to_3d(self):
        ...
        actual = (self.smap3x3.to_3d(depth_map.reshape(1,1,self.img_shape[0],self.img_shape[1]), self.img_shape[0], self.img_shape[1], self.panel, self.img_shape).reshape(3,3,3,self.img_shape[0],self.img_shape[1])[:,offsetx,offsety,active_point_img_coords[0],active_point_img_coords[1]]).cpu().numpy()
    ...
    def test_agg__factor_only(self):
